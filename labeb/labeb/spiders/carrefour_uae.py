...
class CarrefourUAE(scrapy.Spider):
    name = "6021_carrefour_uae"

    custom_settings = {
        "LOG_FILE": f"{name}.log",
        "IMAGES_STORE": "carrefour-uae-images",
        "ITEM_PIPELINES": {
            "labeb.pipelines.CarrefourUaeImagesPipeline": 1,
            "labeb.pipelines.CarrefourUaeCsvPipeline": 300,
            "labeb.pipelines.CarrefourUaeExcelPipeline": 345,
        },
    }
    ...
    def start_requests(self):
        ...
        for category in categories:
            base_url = f"https://www.carrefouruae.com/mafuae/en/c/{category}?currentPage=0&filter=&nextPageOffset=0&pageSize=60&sortBy=relevance"
    ...
    def parse_links(self, response):
        ...
        for product_link in en_listing_urls:
            product_url = "https://www.carrefouruae.com/" + product_link
