...
class LuluKuwait(scrapy.Spider):
    ...
    custom_settings = {
        ...
        "ITEM_PIPELINES": {
            ...
            "labeb.pipelines.LuluKuwaitExcelPipeline": 345,
        },
    }
    ...
    def start_requests(self):
        ...
        for category in categories:
            base_url = f"https://www.luluhypermarket.com/en-kw/c/{category}/results-display?q=%3Adiscount-desc&sort=&page=0"
    ...
    def parse_links(self, response):
        ...
        ar_links = [link.replace("/en-kw/", "/ar-kw/") for link in en_links]
