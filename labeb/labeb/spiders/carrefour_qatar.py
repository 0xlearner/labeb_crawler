...
class CarrefourQatar(scrapy.Spider):
    name = "6052_carrefour_qatar"
    ...
    def start_requests(self):
        ...
        for category in categories:
            base_url = f"https://www.carrefourqatar.com/mafqat/en/c/{category}?currentPage=0&filter=&nextPageOffset=0&pageSize=60&sortBy=relevance"
    ...
    def parse_links(self, response):
        ...
        for product_link in en_listing_urls:
            product_url = "https://www.carrefourqatar.com/" + product_link
