...
class CarrefourKuwait(scrapy.Spider):
    name = "6003_carrefour_kuwait"

    custom_settings = {
        "LOG_FILE": f"{name}.log",
        "IMAGES_STORE": "carrefour-kuwait-images",
        "ITEM_PIPELINES": {
    ...
    def start_requests(self):
        ...
        for category in categories:
            base_url = f"https://www.carrefourkuwait.com/mafkwt/en/c/{category}?currentPage=0&filter=&nextPageOffset=0&pageSize=60&sortBy=relevance"
    ...
    def parse_links(self, response):
        ...
        for product_link in en_listing_urls:
            product_url = "https://www.carrefourkuwait.com/" + product_link
    ...
    def parse_product(self, response):
        ...
        try:
            ...
            try:
                ...
                features_list = [
                    f["features"]
                    for f in json_features_source["classificationAttributes"]
                ]
                features_new = {}
                ...
                if "storageConditions" in json_features_source["attributes"]:
                    features_new["storageConditions"] = json_features_source[
                        "attributes"
                    ]["storageConditions"]
            ...
            #     raw_properties = json.dumps(properties, ensure_ascii=False).encode(
            #         "utf-8"
            #     )
            #     item["properties"] = raw_properties.decode()
            # else:
            ...
            #             features_dict["storageConditions"] = item_attr[
            #                 "storageConditions"
            #             ]
            #         except KeyError:
            #             pass
