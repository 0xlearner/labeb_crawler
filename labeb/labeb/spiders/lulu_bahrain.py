...
class LuluBahrain(scrapy.Spider):
    name = "6045_lulu_bahrain"
    ...
    custom_settings = {
        ...
        "ITEM_PIPELINES": {
            ...
            "labeb.pipelines.LuluBahrainExcelPipeline": 345,
        },
    }
    ...
    def start_requests(self):
        ...
        for category in categories:
            base_url = f"https://www.luluhypermarket.com/en-bh/c/{category}/results-display?q=%3Adiscount-desc&sort=&page=0"
    ...
    def parse_links(self, response):
        ...
        ar_links = [link.replace("/en-bh/", "/ar-bh/") for link in en_links]
