...
class LuluQatar(scrapy.Spider):
    name = "6046_lulu_qatar"

    custom_settings = {
        "LOG_FILE": f"{name}.log",
        "IMAGES_STORE": "lulu-qatar-images",
        "ITEM_PIPELINES": {
    ...
    def start_requests(self):
        ...
        for category in categories:
            base_url = f"https://www.luluhypermarket.com/en-qa/c/{category}/results-display?q=%3Adiscount-desc&sort=&page=0"
    ...
    def parse_links(self, response):
        ...
        ar_links = [link.replace("/en-qa/", "/ar-qa/") for link in en_links]
