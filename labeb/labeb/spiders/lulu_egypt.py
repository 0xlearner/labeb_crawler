...
class LuluEgypt(scrapy.Spider):
    name = "8795_lulu_egypt"

    custom_settings = {
        "LOG_FILE": f"{name}.log",
        "IMAGES_STORE": "lulu-egypt-images",
        "ITEM_PIPELINES": {
            "labeb.pipelines.LuluEgyptImagesPipeline": 1,
            "labeb.pipelines.LuluEgyptCsvPipeline": 300,
            "labeb.pipelines.LuluEgyptExcelPipeline": 345,
        },
    }
    ...
    def start_requests(self):
        ...
        for category in categories:
            base_url = f"https://www.luluhypermarket.com/en-eg/c/{category}/results-display?q=%3Adiscount-desc&sort=&page=0"
    ...
    def parse_links(self, response):
        ...
        ar_links = [link.replace("/en-eg/", "/ar-eg/") for link in en_links]
