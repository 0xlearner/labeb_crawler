...
class LuluUae(scrapy.Spider):
    name = "6043_lulu_uae"

    custom_settings = {
        "LOG_FILE": f"{name}.log",
        "IMAGES_STORE": "lulu-uae-images",
        "ITEM_PIPELINES": {
            "labeb.pipelines.LuluUaeImagesPipeline": 1,
            "labeb.pipelines.LuluUaeCsvPipeline": 300,
            "labeb.pipelines.LuluUaeExcelPipeline": 345,
        },
    }
    ...
    def start_requests(self):
        ...
        for category in categories:
            base_url = f"https://www.luluhypermarket.com/en-ae/c/{category}/results-display?q=%3Adiscount-desc&sort=&page=0"
    ...
    def parse_links(self, response):
        ...
        ar_links = [link.replace("/en-ae/", "/ar-ae/") for link in en_links]
