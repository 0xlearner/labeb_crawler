...
class LuluOman(scrapy.Spider):
    name = "6039_lulu_oman"

    custom_settings = {
        "LOG_FILE": f"{name}.log",
        "IMAGES_STORE": "lulu-oman-images",
        "ITEM_PIPELINES": {
    ...
    def start_requests(self):
        ...
        for category in categories:
            base_url = f"https://www.luluhypermarket.com/en-om/c/{category}/results-display?q=%3Adiscount-desc&sort=&page=0"
    ...
    def parse_links(self, response):
        ...
        ar_links = [link.replace("/en-om/", "/ar-om/") for link in en_links]
